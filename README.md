...
The functioning script will be used as a DAG in apache-airflow to schedule this data generation and load it daily at 7 AM (uct -3) into a google big query.
